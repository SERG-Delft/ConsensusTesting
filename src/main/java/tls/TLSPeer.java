 ...
 * <p/>
 * {@link TLSPeer} implements the handshake protocol, required to establish a connection between two peers,
 * which is common for both client and server and provides the abstract {@link TLSPeer#read(SocketChannel, SSLEngine)} and
 * {@link TLSPeer#write(SocketChannel, SSLEngine, String)} methods, that need to be implemented by the specific SSL/TLS peer
...
public abstract class TLSPeer {
     ...
     * is applied on {@link TLSPeer#myAppData}. It should be initialized using {@link SSLSession#getPacketBufferSize()},
